...
mod tests {
    ...
    fn test_total() {
        assert_eq!(
            get_answer(include_str!("../assets/day22_input_demo1.txt"), 100),
            Some(26)
        );
        assert_eq!(
            get_answer(include_str!("../assets/day22_input_demo1.txt"), 10000000),
            Some(2511944)
        );
        assert_eq!(
            get_answer(include_str!("../assets/day22_input.txt"), 10000000),
            Some(2512135)
        );
    }
}
